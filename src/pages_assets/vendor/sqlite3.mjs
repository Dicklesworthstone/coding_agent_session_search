...
globalThis.sqlite3Worker1Promiser = function callee(config = callee.defaultConfig) {
  ...
  const genMsgId =
    ...
    ((msg) => msg.type + "#" + (idTypeMap[msg.type] = (idTypeMap[msg.type] || 0) + 1));
  const toss = (...args) => {
...
globalThis.sqlite3Worker1Promiser.defaultConfig = {
  worker: () => new Worker(new URL("sqlite3-worker1.mjs", import.meta.url), { type: "module" }),
...
async function sqlite3InitModule(moduleArg = {}) {
  ...
  var FS_handledByPreloadPlugin = async (byteArray, fullname) => {
    ...
    for (var plugin of preloadPlugins)
      if (plugin["canHandle"](fullname)) return plugin["handle"](byteArray, fullname);
    return byteArray;
  };
  ...
  var ydayFromDate = (date) => {
    return (
      (isLeapYear(date.getFullYear()) ? MONTH_DAYS_LEAP_CUMULATIVE : MONTH_DAYS_REGULAR_CUMULATIVE)[
        date.getMonth()
      ] +
      date.getDate() -
      1
  ...
  var _emscripten_resize_heap = (requestedSize) => {
    ...
    for (var cutDown = 1; cutDown <= 4; cutDown *= 2) {
      ...
      if (
        growMemory(
          Math.min(maxHeapSize, alignMemory(Math.max(requestedSize, overGrownHeapSize), 65536)),
        )
      )
        return true;
    }
  ...
  /**
	...
	*/
  Module.runSQLite3PostLoadInit = async (
    ...
    globalThis.sqlite3ApiBootstrap = async function sqlite3ApiBootstrap(
      ...
      /**
			...
			bytes.
			*/
      wasm.allocFromTypedArray = (srcTypedArray) => {
      ...
      /**
			...
			'/'), else returns false.
			*/
      capi.sqlite3_wasmfs_filename_is_persistent = (name) => {
      ...
      /**
			...
			false is returned.
			*/
      capi.sqlite3_js_db_uses_vfs = (pDb, vfsName, dbName = 0) => {
        try {
      ...
      /**
			...
			*/
      capi.sqlite3_js_db_export = (pDb, schema = 0) => {
      ...
      /**
			...
			*/
      capi.sqlite3_value_to_js = (pVal, throwIfCannotConvert = true) => {
        let arg;
      ...
      /**
			...
			*/
      capi.sqlite3_values_to_js = (argc, pArgv, throwIfCannotConvert = true) => {
        let i;
        const tgt = [];
        for (i = 0; i < argc; ++i)
          /**
      ...
      /**
			...
			*/
      capi.sqlite3_result_js = (pCtx, val) => {
      ...
      /**
			...
			*/
      capi.sqlite3_column_js = (pStmt, iCol, throwIfCannotConvert = true) => {
      ...
      /**
			...
			*/
      capi.sqlite3_js_retry_busy = (maxTimes, callback, beforeRetry) => {
    ...
    globalThis.sqlite3ApiBootstrap.initializers.push((sqlite3) => {
      sqlite3.version = {
        libVersion: "3.53.0",
    ...
    globalThis.WhWasmUtilInstaller = function WhWasmUtilInstaller(target) {
      ...
      /** Set up target.ptr... */
      {
        ...
        (function f(name, val) {
          ...
          return f;
        })("null", __NullPtr)("size", __ptrSize)("ir", __ptrIR)("coerce", __asPtrType)(
          "add",
          __ptrAdd,
      ...
      /**
			...
			*/
      target.heapForSize = (n, unsigned = true) => {
        const c =
      ...
      const __SAB = "undefined" === typeof SharedArrayBuffer ? () => {} : SharedArrayBuffer;
      ...
      const __allocCStr = (jstr, returnWithLength, allocator, funcName) => {
      ...
      const __allocMainArgv = (isScoped, list) => {
      ...
      const __allocPtr = (howMany, safePtrSize, method) => {
      ...
      /**
			...
			exception is thrown.
			*/
      target.xGet = (name) => target.exports[name] || toss("Cannot find exported symbol:", name);
      ...
      /**
			...
			*/
      const __xAdapter = (func, argc, typeName, adapter, modeName, xcvPart) => {
      ...
      const finalThen = (arg) => {
        if (config.wasmUtilTarget) {
          ...
          if (!tgt.alloc && arg.instance.exports.malloc) {
            ...
            tgt.alloc = (n) => exports.malloc(n) || toss("Allocation of", n, "bytes failed.");
            tgt.dealloc = (m) => {
              m && exports.free(m);
            };
          }
    ...
    globalThis.Jaccwabyt = function StructBinderFactory(config) {
      ...
      let ptr;
      const ptrSize =
        config.pointerSize || config.ptrSize || ("bigint" === typeof (ptr = alloc(1)) ? 8 : 4);
      ...
      /**
			...
			*/
      const __lookupMember = (structInfo, memberName, tossIfNotFound = true) => {
      ...
      const __SAB = "undefined" === typeof SharedArrayBuffer ? () => {} : SharedArrayBuffer;
      const __utf8Decode = (arrayBuffer, begin, end) => {
        if (8 === ptrSize) {
          begin = Number(begin);
          end = Number(end);
        }
      ...
      /**
			...
			returns false.
			*/
      const __memberIsString = (obj, memberName, tossIfNotFound = false) => {
      ...
      /**
			...
			C-string compatible.
			*/
      const __affirmCStringSignature = (member) => {
      ...
      /**
			...
			*/
      const __setMemberCString = (obj, memberName, str) => {
        const m = __lookupMember(obj.structInfo, memberName, true);
        __affirmCStringSignature(m);
      ...
      /**
			...
			*/
      const memberGetterProxy = (si) =>
        si.get || (si.adaptGet ? StructBinder.adaptGet(si.adaptGet) : void 0);
      /**
			If struct description object si has a setter proxy, return it (a
			function), else return undefined.
			*/
      const memberSetterProxy = (si) =>
        si.set || (si.adaptSet ? StructBinder.adaptSet(si.adaptSet) : void 0);
      /**
      ...
      const StructBinderImpl = function StructBinderImpl(
        ...
        Object.keys(si.members || {}).forEach((k) => {
          ...
          makeMemberWrapper.call(this, StructCtor, k, m);
    ...
    globalThis.sqlite3ApiBootstrap.initializers.push(function (sqlite3) {
      ...
      const bindingSignatures = {
        core: [
          ...
          ["sqlite3_set_auxdata", void 0, ["sqlite3_context*", "int", "*", "*"]],
      ...
      delete globalThis.Jaccwabyt;
      {
        ...
        /**
				...
				*/
        util.sqlite3__wasm_db_error = (pDb, resultCode, message) => {
      ...
      }
      {
        ...
        for (const t of defineGroups)
          for (const e of Object.entries(wasm.ctype[t])) capi[e[0]] = e[1];
        ...
        for (const s of wasm.ctype.structs)
          if (!notThese[s.name]) capi[s.name] = sqlite3.StructBinder(s);
      ...
      __dbCleanupMap.addCollation = (pDb, name) => {
        const m = __dbCleanupMap(pDb, 1);
        if (!m.collation) m.collation = /* @__PURE__ */ new Set();
        m.collation.add(__argStr(name).toLowerCase());
      };
      __dbCleanupMap._addUDF = (pDb, name, arity, map) => {
      ...
      if (capi.sqlite3session_create) {
        const __sqlite3SessionDelete = wasm.xWrap("sqlite3session_delete", void 0, [
          "sqlite3_session*",
        ]);
      ...
      if (!capi.sqlite3_column_text) {
        const argStmt = wasm.xWrap.argAdapter("sqlite3_stmt*"),
          ...
          newStr = (cstr, n) =>
            wasm.typedArrayToString(wasm.heap8u(), Number(cstr), Number(cstr) + n);
        capi.sqlite3_column_text = (stmt, colIndex) => {
      ...
      };
      {
        ...
        capi.sqlite3_reset_auto_extension = () => {
      ...
      const installMethod = function callee(
        ...
        if (!callee.argcProxy) {
          callee.argcProxy = (tgt, funcName, func, sig) =>
            function (...args) {
    ...
    globalThis.sqlite3ApiBootstrap.initializers.push((sqlite3) => {
      ...
      const dbCtorHelper = function ctor(...args) {
        ...
        if ((pDb = opt["sqlite3*"])) {
          ...
          try {
            ...
            const rc = capi.sqlite3_open_v2(fn, pPtr, oflags, vfsName || wasm.ptr.null);
      ...
      /**
			...
			*/
      DB.wrapHandle = (pDb, takeOwnership = false) => {
      ...
      const isSupportedBindType = (v) => {
        const t = BindTypes[null === v || void 0 === v ? "null" : typeof v];
        switch (t) {
      ...
      /**
			...
			*/
      const affirmSupportedBindType = (v) =>
        isSupportedBindType(v) || toss3("Unsupported bind() argument type:", typeof v);
      /**
      ...
      const bindOne = function f(stmt, ndx, bindType, val) {
        ...
        if (!f._) {
          ...
          f._ = {
            string: (stmt, ndx, val, asBlob) => {
              const [pStr, n] = wasm.allocCString(val, true);
              return (asBlob ? capi.sqlite3_bind_blob : capi.sqlite3_bind_text)(
                stmt.pointer,
                ndx,
                pStr,
                n,
      ...
      /**
			...
			argument.
			*/
      Stmt.wrapHandle = (oo1db, pStmt, takeOwnership = false) => {
    ...
    globalThis.sqlite3ApiBootstrap.initializers.push((sqlite3) => {
      ...
      sqlite3.initWorker1API = function () {
        ...
        /** Throws if the given db is falsy or not opened, else returns its
				argument. */
        const affirmDbOpen = (db = wState.dbList[0]) =>
          db && db.pointer ? db : toss("DB is not opened.");
        /** Extract dbId from the given message payload. */
        const getMsgDb = (msgData, affirmExists = true) => {
          const db = wState.getDb(msgData.dbId, false) || wState.dbList[0];
          return affirmExists ? affirmDbOpen(db) : db;
        };
        const getDefaultDbId = () => wState.dbList[0] && getDbId(wState.dbList[0]);
        /**
        ...
        globalThis.onmessage = async (ev) => {
          ...
          try {
            if (Object.hasOwn(wMsgHandler, evType) && wMsgHandler[evType] instanceof Function)
    ...
    globalThis.sqlite3ApiBootstrap.initializers.push((sqlite3) => {
      ...
      /**
			...
			*/
      const __xWrapFactory = (methodName, StructType) =>
        function (ptr, removeMapping = false) {
      ...
      /**
			...
			function.
			*/
      const StructPtrMapper = (name, StructType) => {
    ...
    globalThis.sqlite3ApiBootstrap.initializers.push((sqlite3) => {
      ...
      /**
			...
			*/
      const validateStorageName = (n, mayBeJournal = false) => {
      ...
      const installStorageAndJournal = (store) =>
        (cache.storagePool[store.jzClass] = cache.storagePool[store.jzClass + "-journal"] = store);
      /**
      ...
      /**
			...
			*/
      const notifyListeners = async (eventName, store, ...args) => {
        try {
      ...
      const methodOverrides = {
        ...
        vfs: {
          ...
          xAccess: (pProtoVfs, zPath, flags, pResOut) => {
            cache.popError();
            try {
      ...
      try {
        ...
        for (const e of Object.entries(methodOverrides.vfs)) {
          const k = e[0],
            f = e[1],
            km = pVfs.memberKey(k),
            member = pVfs.structInfo.members[k] || util.toss("Missing pVfs.structInfo[", k, "]");
        ...
        for (const e of Object.entries(methodOverrides.ioDb)) {
          ...
          originalMethods.ioDb[k] =
            wasm.functionEntry(pIoDb[km]) || util.toss("Missing native pIoDb[", km, "]");
        ...
        for (const e of Object.entries(methodOverrides.ioJrnl)) {
          ...
          originalMethods.ioJrnl[k] =
            wasm.functionEntry(pIoJrnl[km]) || util.toss("Missing native pIoJrnl[", km, "]");
      ...
      /**
			...
			Added in version 3.52.0.
			*/
      const sqlite3_js_kvvfs_reserve = (name) => {
      ...
      /**
			...
			Added in version 3.52.0.
			*/
      const sqlite3_js_kvvfs_unlink = (name) => {
        const store = storageForZClass(name);
        if (
          !store ||
      ...
      /**
			...
			Added in version 3.52.0.
			*/
      const sqlite3_js_kvvfs_listen = (opt) => {
      ...
      /**
			...
			Added in version 3.52.0.
			*/
      const sqlite3_js_kvvfs_unlisten = (opt) => {
      ...
      if (sqlite3.__isUnderTest && sqlite3.vtab) {
        ...
        const cursorState = (cursor, reset) => {
        ...
        sqlite3.kvvfs.create_module = (pDb, name = "sqlite_kvvfs") =>
          capi.sqlite3_create_module(pDb, name, theModule(), wasm.ptr.null);
      }
    });
    globalThis.sqlite3ApiBootstrap.initializers.push((sqlite3) => {
      ...
      /**
			...
			*/
      opfsUtil.getResolvedPath = (filename, splitIt) => {
      ...
      /**
			...
			*/
      opfsUtil.mkdir = async (absDirName) => {
        try {
      ...
      /**
			...
			determination.
			*/
      opfsUtil.entryExists = async (fsEntryName) => {
        try {
      ...
      /**
			...
			second argument.
			*/
      const importDbChunked = async (filename, callback) => {
        const [hDir, fnamePart] = await opfsUtil.getDirForFilename(filename, true);
        let sah = await (
            await hDir.getFileHandle(fnamePart, { create: true })
      ...
      /**
			...
			*/
      opfsUtil.importDb = async (filename, bytes) => {
      ...
      opfsUtil.createVfsState = () => {
        ...
        opfsVfs.ioSyncWrappers = util.nu({
          ...
          xDeviceCharacteristics: (pFile) => capi.SQLITE_IOCAP_UNDELETABLE_WHEN_OPEN,
          xFileControl: (pFile, opId, pArg) => capi.SQLITE_NOTFOUND,
        ...
        if (!opfsVfs.$xRandomness)
          opfsVfs.vfsSyncWrappers.xRandomness = (pVfs, nOut, pOut) => {
            const heap = wasm.heap8u();
            let i = 0;
            const npOut = Number(pOut);
            for (; i < nOut; ++i) heap[npOut + i] = (Math.random() * 255e3) & 255;
        ...
        if (!opfsVfs.$xSleep)
          opfsVfs.vfsSyncWrappers.xSleep = (pVfs, ms) => {
            mTimeStart("xSleep");
        ...
        /**
				...
				opfsUtil.createVfsState().
				*/
        opfsVfs.bindVfs = (ioMethods, callback) => {
          ...
          return new Promise((promiseResolve_, promiseReject_) => {
            ...
            let zombieTimer = setTimeout(() => {
              if (void 0 === promiseWasRejected)
                promiseReject(
                  /* @__PURE__ */ new Error("Timeout while waiting for OPFS async proxy worker."),
                );
            }, 4e3);
            ...
            W.onerror = (err) => {
              ...
              promiseReject(
                /* @__PURE__ */ new Error("Loading OPFS async Worker failed for unknown reasons."),
              );
            };
            opfsVfs.opRun;
            const sanityCheck = () => {
    ...
    globalThis.sqlite3ApiBootstrap.initializers.push((sqlite3) => {
      ...
      /**
			...
			available.
			*/
      const installOpfsVfs = async (options) => {
        options = opfsUtil.initOptions("opfs", options);
        if (!options) return sqlite3;
        const capi = sqlite3.capi,
          opfsVfs = opfsUtil.createVfsState().vfs,
    ...
    globalThis.sqlite3ApiBootstrap.initializers.push((sqlite3) => {
      ...
      const ioMethods = {
        ...
        xWrite: (pFile, pSrc, n, offset64) => {
          ...
          try {
            return n ===
              file.sah.write(wasm.heap8u().subarray(Number(pSrc), Number(pSrc) + n), {
                at: HEADER_OFFSET_DATA + Number(offset64),
              })
              ? 0
      ...
      class OpfsSAHPool {
        ...
        async addCapacity(n) {
          for (let i = 0; i < n; ++i) {
            ...
            const ah = await (
              await this.#dhOpaque.getFileHandle(name, { create: true })
            ).createSyncAccessHandle();
      ...
      const apiVersionCheck = async () => {
        ...
        const close = (
          await (await dh.getFileHandle(fn, { create: true })).createSyncAccessHandle()
        ).close();
        await close;
      ...
      /**
			...
			*/
      sqlite3.installOpfsSAHPoolVfs = async (options = Object.create(null)) => {
        ...
        /** The WASM-environment-dependent configuration for sqlite3ApiBootstrap() */
        {
          ...
          exports:
            "undefined" !== typeof wasmExports
              ? wasmExports
              : Object.hasOwn(EmscriptenModule, "wasmExports")
...
sqlite3InitModule = (() => {
  ...
  if (sIMS.moduleScript) {
    const src = sIMS.moduleScript.src.split("/");
    src.pop();
