...
|------------|-----------------|
| `frankensqlite` / `fsqlite-types` | crates.io `=0.3.17` (owner-requested update 2026-09-06; release commit `99aaa531eb4d257feb00d706d6773cc4ecafffa3`, 159 commits since 0.3.16). Adds incremental appended-WAL-tail folding (GH#382), reserved lock-byte/freelist repair (GH#410), FTS metadata preservation and foreign-write visibility (GH#408), prefix-BM25 ranking fixes, prepared-read schema-retry cleanup, and measured trigger/FK stack admission. The async facade and asupersync requirement remain unchanged. Retains 0.3.16's WAL-tail scan fix, GH#405 FTS5 savepoint undo log, GH#406 incremental content-backed INSERT, lazy contentless FTS5, and earlier read-only/Windows/allocator/recovery fixes. 0.3.15 was evaluated and not adopted; historical evidence remains in bead gh382-fsqlite-pin. This update does not prove repair of the owner's existing archive corruption, and upstream GH#411 mixed-engine concurrent-WAL safety remains unresolved. `build.rs` enforces the exact version for the whole fsqlite family. |
