...
|------------|-----------------|
| `frankensqlite` / `fsqlite-types` | crates.io `=0.3.14` (bumped from 0.3.13 in 5acc0dc6 on 2026-09-01 for the FTS5 stock-compat and checkpoint-watermark fixes; 0.3.15 is on crates.io since 2026-09-02 and is under evaluation for the GH #382 writable-open loop, bead g3zyo; asupersync-0.4.3 migration; GH#333/GH#334 fixes including cass#393; allocator/freelist/concurrent-writer correctness work; FTS5 hardening; Windows sidecar-less read-only close repair; checkpoint/recovery and CHECK-enforcement hardening; cass#434 autoindex-vanish corruption-writer fixes). `build.rs` enforces one exact crates.io source/version and rejects fsqlite-family registry patches. |
