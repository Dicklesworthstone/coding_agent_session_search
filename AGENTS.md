...
| `franken-agent-detection` | crates.io `=0.3.1` (indexes Claude Code prompts typed mid-turn, GH#500; honors `CASS_EXCLUDE_PATHS` in the Codex and Pi-family connectors, GH#486; caps session reads while reading) |
