...
const CONTRACTS: &[DependencyContract] = &[
    DependencyContract {
        ...
        // migration, bead bo000; now at 0.4.1. 0.3.15 was evaluated on
    ...
    DependencyContract {
        ...
        // The published 0.4.1 facade uses shared types 0.4.0.
        expected_git: "",
        expected_rev: "",
...
fn validate_fsqlite_source_pin(manifest_dir: &Path, manifest: &Value, packaged_manifest: bool) {
    ...
    // the exact published package versions: the 0.4.1 storage patch updated
    // the facade, core and pager; the remaining family stays at 0.4.0.
