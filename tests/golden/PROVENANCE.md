...
uses fresh CSPRNG salt/IV bytes; the test verifies the raw encrypted documents
differ, then verifies they become identical only after the scrubber replaces
salt/IV/ciphertext with `[SCRUBBED-*]` placeholders.
