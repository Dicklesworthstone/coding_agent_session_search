...
//!
//! cass advertises support for **30 coding-agent providers**: aider, amp,
...
//!      connectors[].name` exactly equals the documented set of 30.
...
/// The canonical set of 30 documented provider connectors. Sourced from the
